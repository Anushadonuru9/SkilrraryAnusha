...
public  class WebDriverUtility {
	 ...
	 * @return
	 */
	public WebDriver lauchBrowserAndMaximize(String browser) {
		switch(browser) {
		case "chrome":
	...
	/**
	 * This method wait until element  is displayed on the web page
	 * @param time
	 * @param element
	 * @return 
	 * @return
	...
	/**
		  * This method is used to wait until title appears the web page
		  * @param time
		  * @param title
		  * @return
		  */
	 ...
	 * @param element
	 */
	public void doubleCliuckOnElement(WebElement element) {
		Actions action=new Actions(driver);
...
/**
 * this method is used to select an element from drop down based on visible test
 * @param text
 * @param element
 */
